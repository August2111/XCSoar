...
class DigitEntry : public PaintWindow {
  ...
  struct Column {
    ...
    constexpr unsigned GetMaxNumber() const {
      switch (type) {
        case Type::HOUR: return 23;
        case Type::DAY: return 30;
        case Type::MONTH: return 11;
        case Type::YEAR: return 199;
        case Type::DIGIT6: return 5;
        case Type::DIGIT19: return 18;
        case Type::DIGIT36: return 35;
        default: return 9;
      }
    }
    ...
    constexpr unsigned GetWidth() const {
      switch (type) {
        case Type::DAY: return 2;
        case Type::MONTH: return 3;
        case Type::YEAR: return 5;
        case Type::UNIT: return 4;
        case Type::HOUR:
        case Type::DIGIT19:
        case Type::DIGIT36: return 2;
        default: return 1;
      }
    }
  };
